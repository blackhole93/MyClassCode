...
/* ~ line 2859: Changed s.t. z_pk_num =/= 1 & z_pk[0] =/= 0 in general but the values of input file */
...
int input_read_parameters(
  ...
  */
  ...
  if (flag1 == _TRUE_) {
    ...
    if ((strstr(string1,"halomodel") != NULL) || (strstr(string1,"Halomodel") != NULL) || (strstr(string1,"HALOMODEL") != NULL)) {
      pnl->method=nl_halomodel;
      ...
      if (flag1 == _TRUE_){
	if ((strstr(string1,"pk") != NULL) || (strstr(string1,"Pk") != NULL) || (strstr(string1,"PK") != NULL)) {
          psp->hm_highest_order = 2;
        }
        if ((strstr(string1,"bk") != NULL) || (strstr(string1,"Bk") != NULL) || (strstr(string1,"BK") != NULL)) {
          psp->hm_highest_order = 3;
        }
        if ((strstr(string1,"tk") != NULL) || (strstr(string1,"Tk") != NULL) || (strstr(string1,"TK") != NULL)) {
          psp->hm_highest_order = 4;
        }
      }
      ...
      if (flag1 == _TRUE_){
	if ((strstr(string1,"ST") != NULL) || (strstr(string1,"Sheth Tormen") != NULL) || (strstr(string1,"st") != NULL)) {
          psp->hm_convention = 1;
        }
        if ((strstr(string1,"T10") != NULL) || (strstr(string1,"Tinker 2010") != NULL) || (strstr(string1,"t10") != NULL)) {
          psp->hm_convention = 2;
        }
        if ((strstr(string1,"B15") != NULL) || (strstr(string1,"Boquet 2015") != NULL) || (strstr(string1,"b15") != NULL)) {
          psp->hm_convention = 3;
        }
      }
      ...
      if (flag1 == _TRUE_){
	if ((strstr(string1,"CS") != NULL) || (strstr(string1,"Cooray Sheth") != NULL) || (strstr(string1,"cs") != NULL)) {
          psp->hm_convention_cm = 1;
        }
        if ((strstr(string1,"L16") != NULL) || (strstr(string1,"Ludlow 2010") != NULL) || (strstr(string1,"l16") != NULL)) {
          psp->hm_convention_cm = 2;
        }
        if ((strstr(string1,"D08") != NULL) || (strstr(string1,"Duffy 2008") != NULL) || (strstr(string1,"d08") != NULL)) {
          psp->hm_convention_cm = 3;
        }
      }
      
      class_read_double("k_11",psp->hm_k_11);
      class_read_double("k_12",psp->hm_k_12);
      class_read_double("k_13",psp->hm_k_13);
      class_read_double("k_21",psp->hm_k_21);
      class_read_double("k_22",psp->hm_k_22);
      class_read_double("k_23",psp->hm_k_23);
      class_read_double("k_31",psp->hm_k_31);
      class_read_double("k_32",psp->hm_k_32);
      class_read_double("k_33",psp->hm_k_33);
      class_read_double("k_41",psp->hm_k_41);
      class_read_double("k_42",psp->hm_k_42); 
      class_read_double("k_43",psp->hm_k_43);
...
int input_default_params(
  ...
  psp->hm_m_slices = 100;
  psp->hm_k_min = 1e-3;
  psp->hm_m_min = 1e8; /* pow(10,8.5)*pow(ppt->k_max_for_pk/30.,3);*/
  psp->hm_m_max = 1e18;
  
  psp->sigma_z_slices = 100;
  psp->sigma_R_slices = 100;
  psp->sigma_m_min = psp->hm_m_min;
  psp->sigma_m_max = 1e18;
